...
const AddressForm = ({ setAdd, uid }) => {
  ...
  return (
    <div className="max-w-xl mx-auto bg-white rounded-lg shadow-md overflow-hidden p-4">
      <div className="flex items-center relative mb-6">
        ...
        <button onClick={() => setAdd(false)}>
          <FaWindowClose className="absolute right-0 top-0 text-2xl text-red-500 hover:text-red-600" />
        </button>
      </div>
