...
const RightIcons = () => {
  ...
  return (
    <div className="flex items-center gap-1">
      {/* <Link
        to="/notifications"
        className="p-2 rounded-full hover:bg-gray-700 transition-colors focus:outline-none focus:ring-2 focus:ring-blue-300"
        ...
        {dropdownOpen && (
          <div className="absolute right-0 mt-3 w-44 bg-white dark:bg-gray-800 border border-blue-100 rounded-lg shadow-lg z-20 animate-fade-in">
            <ul className="py-2">
              ...
              <li className="px-5 py-2 flex items-center justify-between text-gray-700 dark:text-white hover:bg-blue-50 dark:hover:bg-gray-700 transition-colors">
                <span>Dark Mode</span>
